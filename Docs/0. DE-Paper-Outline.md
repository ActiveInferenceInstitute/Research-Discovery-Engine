...
> This outline mirrors the published paper. An expanded companion series covering each topic in depth is available in this directory: `Docs/1. Overview.md` through `Docs/12. Direction.md`.
