...
| **Meta-research audits**                     | Analyse biases, coverage, and structural patterns in a corpus |

These examples describe intended or prototype-supported workflows. Results should be checked against the source literature and the implementation available in the relevant repository component.
